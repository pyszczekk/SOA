...
public class Client {
    ...
    public void addStudent(Student student, String token) {
        ...
        target = client.target(BASE_API_URL);
        response = null;
        target = target.path("db/students");
    ...
    public Student getStudent(int id){
        ...
        target = target.path("db/students").path(Integer.toString(id));
    ...
    public void updateStudent(Student student, String token){
        ...
        target = target.path("db/students").path(Integer.toString(student.getStudentId()));
    ...
    public List<String> getStudentCourses(int id){
        ...
        target = target.path("db/students").path(Integer.toString(id)).path("courses");
        response = target.request().get();
